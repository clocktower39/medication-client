...
function getStepContent(step, page1, page2) {
  switch (step) {
    case 0:
      return <PatientDemographics values={page1.values} setters={page1.setters} />;
    case 1:
...
export default function PatientEnrollmentForm() {
  ...
  const page1 = {
    ...
    setters:[setFirstName, setLastName, setPhoneNumber, setDateOfBirth]
  }
  const page2 = {
    values:[address1, address2, city, state, zip, country],
    setters:[setAddress1, setAddress2, setCity, setState, setZip, setCountry]
  }
